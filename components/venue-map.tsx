...
export default function VenueMap() {
  ...
  // Google Maps URL for Occidental Grand Hotel Sharjah
  const googleMapsUrl = "https://maps.app.goo.gl/UeR6tCEMUsa4s3ZC9"
          ...
          <div className="mt-6 text-center px-4">
            ...
            <div className="text-foreground text-sm sm:text-base mb-3 space-y-1">
              {isRTL ? (
                ...
                <>
                  <div>Al Meena St - Al Khalidiya District</div>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 text-xs sm:text-sm text-foreground">
              <div className="flex items-center gap-2">
                ...
                <span>{isRTL ? 'الشارقة، الإمارات' : 'Sharjah, UAE'}</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
