    ...
    >
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="font-luxury text-lg md:text-xl text-foreground mb-8 italic max-w-2xl mx-auto">{t('rsvpDescription')}</p>
        </motion.div>
          ...
          <form onSubmit={handleSubmit} className="relative z-10 space-y-6">
            ...
            {attending === 'yes' && (
              <>
                ...
                >
                  <label htmlFor="rsvp-song" className="block text-sm font-medium text-foreground mb-2 font-luxury">
                    {t('rsvpFormSong')}
                  </label>
                  <input
                    id="rsvp-song"
                    ...
                    placeholder={language === 'ar' ? 'اكتب اسم الأغنية' : 'Enter song name'}
                    className="w-full px-4 py-3 bg-background/50 border-2 border-accent/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all font-luxury"
                    disabled={isSubmitting}
                  />
                </motion.div>
