...
export const translations: Translations = {
  ...
  ourSpecialDay: {
    en: 'Bashar & Rania\'s Wedding Day',
    ar: 'زفاف بشار و رانيا',
  },
  countingMoments: {
    en: 'Counting every moment to celebrate our wedding',
    ar: 'نعد كل لحظة للاحتفال بزفافنا',
  },
  joinUsAt: {
    en: 'Join Us At',
    ar: 'نلتقي في',
  ...
  location: {
    en: 'Occidental Grand Hotel Sharjah, Al Meena St - Al Khalidiya District - Sharjah - United Arab Emirates',
    ar: 'فندق أوكسيدنتال جراند الشارقة، شارع المينة - حي الخالدية - الشارقة - الإمارات العربية المتحدة',
  },
  rsvpTitle: {
    en: 'Will You Join Us?',
    ar: 'هل ستنضم إلينا؟',
  ...
  rsvpDescription: {
    en: 'We would be honored to have you celebrate our wedding with us',
    ar: 'سيكون لنا الشرف بوجودكم معنا في زفافنا',
  },
  rsvpButton: {
    en: 'RSVP Now',
    ar: 'تأكيد الحضور',
  ...
  rsvpFormSong: {
    en: 'Song you\'d like to dance to',
    ar: 'أغنية ترغب في الرقص عليها',
  },
  rsvpFormSubmit: {
    en: 'Submit',
    ar: 'إرسال',
  ...
  footerMessage: {
    en: "CANT WAIT TO CELEBRATE WITH YOU",
